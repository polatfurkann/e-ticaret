    ...
    <tr>
        <td width="500" valign="top">
            <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="30">
                    <td align="center"><a href="index.php?SK=51" class="BilgilerimiGuncelleButonu">Bilgilerimi Güncellemek İsiyorum</a></td>
                </tr>                    
            </table>
        </td>
        ...
        <td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr height="30">
                <td valign="top" style="border-bottom: 1px dashed #CCCCCC;">AFTP Reklamları</td>
            </tr>  
            <tr height="5">
                <td height="5" style="font-size: 5px;">&nbsp;</td>
            </tr> 
            <tr>
                <td><b><img src="Resimler/reklam.jpg" border="0"></b></td>
            </tr>              
        </table></td>
    </tr>   
</table>
