		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnYeniUrunKayitlari as $EnYeniUrunSatirlari){
					...
					if($EnYeniUrununTuru=="Kayısı Çeşitleri"){
						$EnYeniUrunResimKlasoru		=	"kayisi";
					}elseif($EnYeniUrununTuru=="Kuruyemiş"){
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnPopulerUrunKayitlari as $EnPopulerUrunSatirlari){
					...
					if($EnPopulerUrununTuru=="Kayısı Çeşitleri"){
						$EnPopulerUrunResimKlasoru		=	"kayisi";
					}elseif($EnPopulerUrununTuru=="Kuruyemiş"){
						$EnPopulerUrunResimKlasoru		=	"kuruyemis";
					}
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnCokSatanUrunKayitlari as $EnCokSatanUrunSatirlari){
					...
					if($EnCokSatanUrununTuru=="Kayısı Çeşitleri"){
						$EnCokSatanUrunResimKlasoru		=	"kayisi";
					}elseif($EnCokSatanUrununTuru=="Kuruyemiş"){
