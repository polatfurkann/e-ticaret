...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
			...
			<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				if($SepettekiUrunSayisi>0){
					...
					foreach($SepettiKayitlar as $SepetSatirlari){
						...
						if($UrununTuru=="Kayısı Çeşitleri"){
							$UrunResimleriKlasoru	=	"kayisi";
						}elseif($UrununTuru=="Kuruyemiş"){
				...
				<tr height="100">
					<td valign="bottom" align="left"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="40" style="border-bottom: 1px dashed #CCCCCC;" align="left"><a href="index.php?SK=94&ID=<?php echo DonusumleriGeriDondur($SepetIdsi); ?>"><img src="Resimler/SilDaireli20x20.png" border="0"></a></td>
							...
							<td width="90" style="border-bottom: 1px dashed #CCCCCC;" align="left"><table width="90" align="center" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="30" align="center"><?php if($SepettekiUrununAdedi>1){ ?><a href="index.php?SK=95&ID=<?php echo DonusumleriGeriDondur($SepetIdsi); ?>" style="text-decoration: none; color: #646464;"><img src="Resimler/AzaltDaireli20x20.png" border="0" style="margin-top: 5px;"></a><?php }else{ ?>&nbsp;<?php } ?></td>
									<td width="30" align="center" style="line-height: 20px;"><?php echo DonusumleriGeriDondur($SepettekiUrununAdedi); ?></td>
									<td width="30" align="center"><a href="index.php?SK=96&ID=<?php echo DonusumleriGeriDondur($SepetIdsi); ?>"><img src="Resimler/ArttirDaireli20x20.png" border="0" style="margin-top: 5px;"></a></td>
								</tr>
							</table></td>
		...
		<td width="250" valign="top"><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="right"><div class="SepetIciDevamEtVeAlisverisiTamamlaButonu"><a href="index.php?SK=97"><img src="Resimler/SepetBeyaz21x20.png" border="0"> <div>DEVAM ET</div></a></div></td>
			</tr>
		</table></td>
	</tr>
</table>	
