...
$UrunSorgusuKaydi	=	$UrunSorgusu->fetch(PDO::FETCH_ASSOC);
	...
	if($UrunSayisi>0){
		$UrunTuru	=	$UrunSorgusuKaydi["UrunTuru"];
			if($UrunTuru=="Kayısı Çeşitleri"){
				$ResimKlasoru	=	"kayisi";
			}elseif($UrunTuru=="Kuruyemiş"){
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="705" valign="top"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><form action="index.php?SK=90&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>" method="post"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr height="45">
						...
						<td width="30"><?php if(isset($_SESSION["Kullanici"])){ ?><a href="index.php?SK=86&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>"><img src="Resimler/KalpKirmiziDaireliBeyaz24x24.png" border="0" style="margin-top: 5px;"></a><?php }else{ ?><img src="Resimler/KalpKirmiziDaireliBeyaz24x24.png" border="0" style="margin-top: 5px;"><?php } ?></td>
						<td width="10">&nbsp;</td>
