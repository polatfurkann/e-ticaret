...
if(isset($_SESSION["Kullanici"])){
	...
	if($SepettekiUrunSayisi>0){
		...
		$okUrl			=	"http://www.aftp.com/alisverissepetikredikartiodemesonuctamam.php";	//	Ödeme İşlemi Başarıyla Gerçekleşir ise Dönülecek Sayfa
		$failUrl		=	"http://www.aftp.com/alisverissepetikredikartiodemesonuchata.php";	//	Ödeme İşlemi Red Olur ise Dönülecek Sayfa
		$rnd			=	@microtime();
