<form action="index.php?SK=15" method="post">
    <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="50">
            <td align="left" style="border-bottom: 1px dashed #CCCCCC;">&nbsp;Aklınıza takıbileceğini düşündüğümüz soruların cevaplarını bu sayfada cevapladık. Fakat farklı bir sorunuz varsa lütfen iletişim alanından bizlere iletiniz.</td>
        </tr>     
        <tr>
            <td><?php
